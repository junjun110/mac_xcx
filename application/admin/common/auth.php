...
return array(
    ...
    '13' => array('name' => '小程序', 'icon' => 'xe621', 'sub' => array(
        '131' => array("show"=>1,'name' => '系统设置', 'controller' => 'xcxsys',		'action' => 'index', 'param'=>''),

        '132' => array("show"=>1,'name' => '广告管理', 'controller' => 'urlsend',		'action' => 'index', 'param'=>''),
        '133' => array("show"=>1,'name' => '网络电视直播', 'controller' => 'urlsend',		'action' => 'push'),
        '134' => array("show"=>1,'name' => '公告管理', 'controller' => 'urlsend',		'action' => 'baidu_push'),
